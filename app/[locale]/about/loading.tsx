	...
	return (
		<div className="flex flex-col justify-center content-center w-3/4 md:max-w-3xl min-h-[70vh] md:min-h-[80vh] gap-5 mx-auto">
			<div className="flex flex-col justify-center content-center">
				<div className="h-10 w-48 bg-accent rounded animate-pulse mb-5" />
				<div className="h-20 w-full bg-accent rounded animate-pulse mb-4" />
				<div className="h-20 w-full bg-accent rounded animate-pulse" />
